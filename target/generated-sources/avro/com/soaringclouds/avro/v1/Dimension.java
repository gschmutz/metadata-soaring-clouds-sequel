 ...
 */
package com.soaringclouds.avro.v1;
...
public class Dimension extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 626620733108730246L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Dimension\",\"namespace\":\"com.soaringclouds.avro.v1\",\"fields\":[{\"name\":\"unit\",\"type\":[\"string\",\"null\"]},{\"name\":\"length\",\"type\":[\"double\",\"null\"]},{\"name\":\"height\",\"type\":[\"double\",\"null\"]},{\"name\":\"width\",\"type\":[\"double\",\"null\"]}]}");
   ...
   */
  public static com.soaringclouds.avro.v1.Dimension.Builder newBuilder() {
    return new com.soaringclouds.avro.v1.Dimension.Builder();
  }
   ...
   * @return A new Dimension RecordBuilder
   */
  public static com.soaringclouds.avro.v1.Dimension.Builder newBuilder(com.soaringclouds.avro.v1.Dimension.Builder other) {
    return new com.soaringclouds.avro.v1.Dimension.Builder(other);
  }
   ...
   * @return A new Dimension RecordBuilder
   */
  public static com.soaringclouds.avro.v1.Dimension.Builder newBuilder(com.soaringclouds.avro.v1.Dimension other) {
    return new com.soaringclouds.avro.v1.Dimension.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Dimension>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.soaringclouds.avro.v1.Dimension.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.soaringclouds.avro.v1.Dimension other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.unit)) {
        this.unit = data().deepCopy(fields()[0].schema(), other.unit);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.soaringclouds.avro.v1.Dimension.Builder setUnit(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.soaringclouds.avro.v1.Dimension.Builder clearUnit() {
      unit = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.soaringclouds.avro.v1.Dimension.Builder setLength(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.soaringclouds.avro.v1.Dimension.Builder clearLength() {
      length = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.soaringclouds.avro.v1.Dimension.Builder setHeight(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.soaringclouds.avro.v1.Dimension.Builder clearHeight() {
      height = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.soaringclouds.avro.v1.Dimension.Builder setWidth(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.soaringclouds.avro.v1.Dimension.Builder clearWidth() {
      width = null;
